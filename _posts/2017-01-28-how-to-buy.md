...
You will be better off using either Bitfinex or Kraken for larger BTC-to-altcoin trades. Choose according to your preference:

* Bitstamp is the only one that will need to have you KYC verified even to deposit BTC.
* Kraken's website can get a little cranky.
* Bitfinex has the lowest fees but quite a complicated interface.  
