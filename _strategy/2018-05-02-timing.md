...
description:  "Timing the market has a bad rap - for no reason. There are strategic approaches to it, even on crypto markets."
...
Timing is simply a method to learn about the bigger picture. In case of crypto that is the strength of all crypto markets, rether than just the one you trade on.
...
**2. Both BTCUSD and CCI30 goes up**, but the price of BTCUSD is growing at a faster pace.
